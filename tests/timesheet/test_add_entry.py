...
class AddEntryTestCase(unittest.TestCase):
    def test_add_empty_timesheet(self):
        ...
        self.assertEqual(entries[today][0].alias, 'foo')
        self.assertEqual(entries[today][0].duration, 2)
    ...
    def test_add_entry_empty_end_time(self):
        ...
        self.assertEqual(lines, ['13.10.2012', '', 'foo 00:00-? bar'])
...
foo 09:00-10:00 baz"""
        ...
        self.assertEqual(len(entries[datetime.date(2012, 10, 10)]), 2)
        self.assertEqual(len(entries[datetime.date(2012, 10, 20)]), 1)

        self.assertEqual(t.entries.to_lines(), ['10.10.2012', 'foo 09:00-10:00 baz',
        ...
        self.assertEqual(t.entries.to_lines(), ['25.10.2012', '', 'bar 2 baz', '',
...
"""
        ...
        self.assertEqual(t.entries.to_lines(), [
